...
export const authService = {
  login: (_: Request, res: Response) => {
    ...
    // res.redirect(
    //   'https://accounts.spotify.com/sv/authorize?response_type=code&client_id=f8f1a87f489e411da6b5bf741c103b49&scope=user-read-private%20user-read-email&state=9XuQx8U3Z0hjujNV&redirect_uri=http%3A%2F%2Flocalhost:3000/home'
    // )
    res.redirect(
